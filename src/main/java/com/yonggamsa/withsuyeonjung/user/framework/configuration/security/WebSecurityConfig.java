...
import com.yonggamsa.withsuyeonjung.user.framework.configuration.YamlPropertySourceFactory;
import com.yonggamsa.withsuyeonjung.user.framework.configuration.security.oauth.exception.RestAuthenticationEntryPoint;
import com.yonggamsa.withsuyeonjung.user.framework.configuration.security.oauth.handler.OAuth2AuthenticationFailureHandler;
import com.yonggamsa.withsuyeonjung.user.framework.configuration.security.oauth.handler.OAuth2AuthenticationSuccessHandler;
import com.yonggamsa.withsuyeonjung.user.framework.configuration.security.oauth.handler.TokenAccessDeniedHandler;
